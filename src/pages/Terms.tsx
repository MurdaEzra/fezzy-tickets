  ...
  <div className="fezzy-editorial min-h-screen bg-ink text-cream">
    ...
    <main className="mx-auto max-w-1440 px-5 py-16 md:py-24 lg:px-8">
      <div className="max-w-3xl">
        ...
        <h1 className="font-display text-5xl text-cream sm:text-6xl">Terms & Conditions</h1>
        ...
        <article className="mt-12 max-w-none space-y-8 text-sm leading-relaxed text-cream-dim">
          <section>
            <h2 className="font-display text-2xl text-cream">1. Acceptance</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">2. The service</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">3. Accounts</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">4. Buyer terms</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">5. Organizer terms</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">6. Fees & payments</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">7. Cancellations & refunds</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5">
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">8. Prohibited use</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">10. Disclaimer & liability</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">11. Indemnity</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">12. Governing law</h2>
          ...
          <section>
            <h2 className="font-display text-2xl text-cream">13. Changes</h2>
          ...
          <section>
            ...
            <p className="mt-3">Questions about these Terms? Reach us at <a href="mailto:support@fezzytickets.com" className="font-semibold text-fezzy hover:text-lime">support@fezzytickets.com</a>.</p>
          </section>
        </article>
      </div>
    </main>
