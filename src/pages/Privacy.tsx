...
const Privacy = () => (
  <div className="min-h-screen bg-background">
    ...
    <main className="container-px mx-auto max-w-3xl py-16 md:py-24">
      ...
      <h1 className="display text-5xl text-foreground sm:text-6xl">Privacy Policy</h1>
      ...
      <article className="prose prose-neutral mt-12 max-w-none space-y-8 text-sm leading-relaxed text-foreground/90">
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">2. Data we collect</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li><strong>Account data:</strong> name, email, phone, country, password hash, and the date you created your account.</li>
            <li><strong>Ticket data:</strong> the events you browse, the tiers you select, the orders you place, the QR tokens issued to you, and the entry-scan timestamps.</li>
            <li><strong>Organizer data:</strong> organization name, public handle, contact details, bio, logo, bank or M-Pesa subaccount metadata held by our payment processor, and platform fee history.</li>
            <li><strong>Payment data:</strong> we never store full card numbers. Paystack handles card and M-Pesa details directly; we receive a payment reference, the amount, the status, and the masked instrument used.</li>
            <li><strong>Device data:</strong> IP address, browser type, device type, language, and basic usage analytics needed to operate and protect the service.</li>
            <li><strong>Optional marketing data:</strong> if you opt in, we record your consent timestamp and the source of the opt-in.</li>
          </ul>
        </section>

        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">3. How we use it</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5">
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">4. Legal bases</h2>
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">5. Sharing</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li><strong>Organizers</strong> of events you buy tickets to receive the ticket-holder name, email, phone, tier, and order reference, so they can communicate with you and validate entry.</li>
            <li><strong>Payment processors</strong> (Paystack) receive the data needed to process your payment and split funds to the organizer's subaccount.</li>
            <li><strong>Email delivery</strong> (Brevo) receives recipient address and email content needed to send ticket-delivery and account emails.</li>
            <li><strong>Cloud infrastructure</strong> (Supabase, Lovable Cloud) hosts our database and edge functions under data-processing agreements.</li>
            <li><strong>Authorities</strong> when we are legally required to disclose information.</li>
          </ul>
          <p className="mt-3">We do not sell your personal data.</p>
        </section>

        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">6. Cookies & similar tech</h2>
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">10. International transfers</h2>
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">11. Children</h2>
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">12. Changes</h2>
        ...
        <section>
          <h2 className="font-display text-2xl font-bold text-foreground">13. Contact</h2>
          <p className="mt-3">Privacy questions or requests: <a href="mailto:privacy@fezzy.app" className="font-semibold text-primary hover:underline">privacy@fezzy.app</a>.</p>
        </section>
      </article>
    </main>
    <Footer />
